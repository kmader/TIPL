...
def runTexture(ptxtFile,outFile,steps,lstep,dirV,isoSteps,useLstep,useBubbles,useRadPos,doStrain,keepExtremes=False,trimEdge=1,edges=None,minObj=2):
	#outFile=sys.argv[2]
...
if __name__ == "__main__":
	...
	if len(sys.argv)>3:
		...
		resMat=runTexture(ptxtFile,outFile,steps,lstep,dirV,isoSteps,useLstep,useBubbles,useRadPos,doStrain,trimEdge=0,edges=edges)
		print resMat
