...
class WindroseAxes(PolarAxes):
    ...
    def _init_plot(self, dir, var, **kwargs):
        ...
        self._info['dir'], self._info['bins'], self._info['table'] = wrhistogram(dir, var, bins, nsector, normed, blowto)
...
def wrhistogram(dir, var, bins, nsector, normed=False, blowto=False):
    """
