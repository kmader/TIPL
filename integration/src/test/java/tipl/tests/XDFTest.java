...
public class XDFTest {
    ...
    protected static ITIPLPluginIO makeXDF(TIPLPluginManager.PluginInfo plugName, final TImgRO inImage) {
        final ITIPLPluginIO XF = (ITIPLPluginIO) TIPLPluginManager.getPlugin(plugName);
		XF.LoadImages(new TImgRO[] { inImage });
		return XF;
	}
	protected static ITIPLPluginIO makeXDF(TIPLPluginManager.PluginInfo plugName, final TImgRO inImage,final TImgRO valueImage) {
        final ITIPLPluginIO XF = (ITIPLPluginIO) TIPLPluginManager.getPlugin(plugName);
    ...
    public static Collection<TIPLPluginManager.PluginInfo[]> getPlugins() {
        List<TIPLPluginManager.PluginInfo> possibleClasses = TIPLPluginManager.getPluginsNamed("XDF");
	 ...
	 * Test method for
     * @
	 * {@link tipl.tools.XDF#WriteHistograms(tipl.tools.XDF, tipl.formats.TImgRO.CanExport, TypedPath)}
	 * .
	 */
	@Test
