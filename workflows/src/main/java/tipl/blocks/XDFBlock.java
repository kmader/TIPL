...
public class XDFBlock extends BaseTIPLBlock {
     ...
     * a fixed structure, but others include A to be phase correlations and ...
     *
     * @author mader
     */
    ...
    public boolean executeBlock() {
        ...
        XDF.WriteHistograms((XDF) cXDF, TImgTools.makeTImgExportable(inputAim),
                getFileParameter("rdf"));
        return true;
    }
