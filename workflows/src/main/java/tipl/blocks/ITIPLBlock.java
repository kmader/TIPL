 ...
 * independently the blocks can have prerequisites which will be checked before they are run
 *
 * @author mader
 */
public interface ITIPLBlock {
    ...
    /**
     * The IBlockInfo interface is used to supply inputs and outputs to Blocks / functions
     *
     * @author mader
     */
    ...
    /**
     * Connects the input of this block to the output of another block (output of other block
     * overrides this blocks name)
     *
     * @param inputName   input field from this block to overwrite
     * @param outputBlock block to connect to
     * @param outputName  the name of the field being connected
     */
    ...
    /**
     * get an input file (handles loading and everything in a consistent manner and returns null if
     * the image is empty
     *
    ...
    /**
     * has the block completed or are all of the files, etc present which indicate completion
     */
    ...
    /**
     * Inputs can be given to the block through the setParameters command using the ArgumentParser
     * class
     *
     * @param p input arguments
    ...
    /**
     * A class to handle IO for the blocks (either locally, through Hadoop or otherwise) basically
     * it makes it more straightforward to pass images in as objects instead of paths
     */
