...
public class FoamThresholdBlock extends ThresholdBlock {
    ...
    final public static class foamThreshBlockFactory implements BaseTIPLBlock.TIPLBlockFactory {
        @Override
    ...
    protected String getDescription() {
        return super.getDescription() + " with additional morphological operations to clean foam " +
                "images";
    }
    ...
    public ArgumentParser setParameterBlock(final ArgumentParser inp) {
        ...
        clthresh = p.getOptionBoolean(prefix + "clthresh", "Perform component labeling on " +
                "thresheld image");
        clnotthresh = p.getOptionBoolean(prefix + "clnotthresh", "Perform component labeling on " +
                "inverse thresheld image");
