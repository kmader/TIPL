...
public class DirectoryIOTest {
	...
	public static final TypedPath dmpPath= TIPLStorageManager.openPath("/Users/mader/Dropbox/TIPL" +
			"/test/io_tests/rec_DMP");
	public static final TypedPath tifPath=TIPLStorageManager.openPath("/Users/mader/Dropbox/TIPL/test/io_tests/rec8bit");
	/** to test if folders with extensions *.tiff can be read as well **/
	public static final TypedPath tiffPath=TIPLStorageManager.openPath("/Users/mader/Dropbox/TIPL/test/io_tests/rec8tiff");
	public static final TypedPath tif16Path=TIPLStorageManager.openPath("/Users/mader/Dropbox/TIPL/test/io_tests/rec16bit");
	public static final TypedPath isqPath=TIPLStorageManager.openPath("/Users/mader/Dropbox/TIPL/test/io_tests/test.isq;2");
	/**
