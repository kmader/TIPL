...
object KVImgTests {
  ...
  val kvTool = testImg.toKV()
  //> 14/07/26 10:29:03 INFO SparkConf: Using Spark's default log4j profile: org/a
  ...
  val fval = kvTool.getBaseImg.first //> 14/07/26 10:29:08 INFO SparkContext: Starting job: first
  // at spark.images.KVI
  //| mgTests.scala:29
