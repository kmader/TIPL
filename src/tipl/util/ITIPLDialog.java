...
/**
 * An interface for interacting with GUIs so that AWT, GWT, Pivot, and JavaFX 
 * can be used for setting parameters
 * @author mader
 *
 */
public interface ITIPLDialog extends Serializable {
    ...
    /**
	 * A task to be run before the window is closed
	 * often used to push values forward
	 * @param curTask
	 */
	...
	/**
	 * A simple interface to have a callback when something happens (for example preview is clicked)
	 * @author mader
	 *
	 */
