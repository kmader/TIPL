...
public class SGEJob {
     ...
     *
     * @param p given input arguments p
     */
     ...
     *
     * @param p      given input arguments p
     * @param prefix text to be used before each argument, (preferably format xyz:)
     */
     ...
     * Creates a new SGEJob using the given input arguments p, with the prefix
     *
     * @param className is the name of the class to run
     * @param p         given input arguments p
     * @param prefix    text to be used before each argument, (preferably format xyz:)
     */
     ...
     * Creates a new SGEJob using the given input arguments p, with the prefix
     *
     * @param scriptPath is the path of the script to run
     * @param p          given input arguments p
     * @param prefix     text to be used before each argument, (preferably format xyz:)
     */
