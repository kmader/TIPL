...
abstract public class BaseTIPLPluginMult extends BaseTIPLPlugin {
	 ...
	 * thread from the main functions. For TIPLPluginMult this function calls the
	 * appropriate abstract sub-function dealing with the given datatype. It is
	 * however transparent to the user
	 */
	@Override
