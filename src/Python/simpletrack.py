...
inLine+='\n'
out.write(inLine)
inLine='//Component 1, Component 2, Match_Quality, POS_X,POS_Y,POS_Z,DIR_X,DIR_Y,DIR_Z\n'
...
for aLac in sorted(matchDict.keys()):
	...
	if (lacA.has_key(aLac) & lacB.has_key(bLac)):
		...
		avgPos=aPos
		vecDir=bPos-aPos
		out.write('%i,%i,%f,%f,%f,%f,%f,%f,%f\n' % (aLac,bLac,mQual,avgPos[0],avgPos[1],avgPos[2],vecDir[0],vecDir[1],vecDir[2]))
