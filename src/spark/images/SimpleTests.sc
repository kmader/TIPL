...
object SimpleTests {
  ...
  val jsc = SparkGlobal.getContext("FunnyTests")  //> 14/07/25 10:41:39 INFO SparkConf: Using Spark's default log4j profile: org/
  ...
  val fSlice = imFolder.first                     //> 14/07/25 10:41:43 INFO FileInputFormat: Total input paths to process : 5
  ...
  val rimFolder = imFolder.toTiffSlices           //> 14/07/25 10:41:43 INFO SparkContext: Starting job: first at IOOps.scala:54
...
val b = t.byteFolder(testPath)                    //> 14/07/25 10:41:44 INFO MemoryStore: ensureFreeSpace(177830) called with cur
