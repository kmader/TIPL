 ...
 */
@serializable case class SinogramSettings(imgPath: String, savePath: TypedPath, checkpointResults: Boolean, maxDarkVal: Double, maxProjVal: Double, minFlatVal: Double, maxSino: Int)
